			...
			>
				<div className={classes.wrapper}>
					...
					<Typography variant='h5' component='h4'>
						Status
						<span style={{ marginLeft: "50px", marginRight: "10px" }}> : </span>{" "}
						{styles.title}
					</Typography>
					<Typography variant='h5' component='h4'>
						Peminjam
						<span style={{ marginLeft: "11px", marginRight: "10px" }}> : </span>{" "}
						{borrowingList.name}
					</Typography>
					...
					<Typography variant='h5' component='h4'>
						Tanggal
						<span style={{ marginLeft: "33px", marginRight: "10px" }}> : </span>{" "}
						{borrowingList.startDate}
					</Typography>
					<Typography variant='h5' component='h4'>
						Waktu
						<span style={{ marginLeft: "50px", marginRight: "10px" }}> : </span>{" "}
						{borrowingList.time} WITA
					</Typography>
				</div>
			</Dialog>
		</div>
